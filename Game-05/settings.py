...
# final upscale stays crisp. The aspect ratio is 256:312 (portrait) --
# the board sits on top and a combat strip for the two characters sits
# below it -- and WINDOW keeps that same ratio (x3) so gale's
# scale-to-window-size blit doesn't stretch it.
VIRTUAL_WIDTH = 256
VIRTUAL_HEIGHT = 312
...
_COMBAT_ZONE_Y = BOARD_Y + BOARD_PIXEL_HEIGHT + 8
...
CHARACTER_SPRITE_SCALE = 3  # ...then blown up 3x with nearest-neighbor scaling.
CHARACTER_SPRITE_SIZE = CHARACTER_SPRITE_BASE_SIZE * CHARACTER_SPRITE_SCALE

HP_BAR_WIDTH = 64
HP_BAR_HEIGHT = 8
HP_BAR_OFFSET_Y = CHARACTER_SPRITE_SIZE // 2 + 14  # above the sprite's anchor
...
# with the same index.
TILES_IMAGE_PATH = BASE_DIR / "tiles.png"
